...
<script>
   ...
   let idapertura =  null;
        $(document).ready(() => {
            $('#prematriculas').jtable({
               ...
               //defaultSorting: 'nombe ASC', // ordenado ascendente
                ...
                actions: {
                      listAction: '<?php echo site_url(); ?>movimientos/Prematriculas/lista',
                ...
                recordsLoaded: (event, data) => {
                    ...
                    $('.edit-row').click(function(e) {
                        ...
                        window.location.href = `<?php echo site_url(); ?>movimientos/Prematriculas/edit/${id}`;      
                    });
    ...
    const excel = (idapertura) => {
      ...
      //  debugger;
         window.location.href = "<?php echo site_url(); ?>movimientos/Prematriculas/excel?idapertura="+idapertura;
       //  console.log('loquita');
    }
