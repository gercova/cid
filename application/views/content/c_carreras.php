        ...
        $(document).ready(() => {
            ...
            $('#listado').jtable({
               ...
               defaultSorting: 'Orde date ASC', // ordenado ascendente
                ...
                actions: {
                     listAction: '<?php echo site_url(); ?>mantenimiento/carreras/lista',
                ...
                fields: {
                    ...
                    $('.edit-row').click(function(e) {
                        ...
                        console.log(id),
                        //window.location.href = `<?php echo site_url(); ?>administrador/carreras/edit/${id}`;
                        //LoadRecordsButton.click();
  
                        $.ajax({
                                url: base_url + "mantenimiento/carreras/edit",
                                method: "POST",
                                data:{id:id},
                                dataType: "json"
                        })
                            ...
                            // console.log(result);
                                ...
                                $(".modal-title-titulo").text("Editar Aula");        
                    ...
                    $('.delete-row').click(function(e) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                console.log(id)
                                const url = `<?php echo site_url(); ?>mantenimiento/carreras/delete/${id}`;
                                fetch(url)
                                    .then(res=>res.json())
                                    .then(res => {
                                        console.log(res)
...
const newRecord = () => {
    $("#form_carreras").trigger("reset");
    $(".modal-header-color").css("background-color", "#007bff");
    $(".modal-header-color").css("color", "white");
    $(".modal-title-titulo").text("Nueva Aula");            
    $("#modalCRUD").modal("show");        
    id="";
    }
...
$("#form_carreras").submit(function(e){
   ...
   // console.log(email);
    ...
    $.ajax({
        url: "<?php echo base_url(); ?>mantenimiento/carreras/store",
        type: "POST",
        dataType: "json",
