...
<script>
        ...
        $(document).ready(() => {
            $('#matriculas').jtable({
               ...
               //defaultSorting: 'nombe ASC', // ordenado ascendente
                actions: {
                   listAction: '<?php echo site_url(); ?>matriculas/matriculas/lista',
                    // createAction: '<?php echo base_url(); ?>matriculas/matriculas/create"',
                    // updateAction: 'jj',
                //    deleteAction: '',
                },
                toolbar: {
                    items: [
						...
						},
                        {
                            ...
                            text: `<i class="fa fa-plus"></i> Nueva Matricula`,
                            click: function () {
                ...
                recordsLoaded: (event, data) => {
                    ...
                    $('.edit-row').click(function(e) {
                        ...
                        window.location.href = `<?php echo site_url(); ?>matriculas/matriculas/edit/${id}`;      
                    });
                    ...
                    $('.view-row').click(function(e) {
                        ...
                        let id = $(this).attr('data-id');
                        $.ajax({
                            url: base_url + "matriculas/matriculas/view/" + id,
                            type:"POST",
                            success:function(resp){
                                $("#modal-matriculas .modal-body").html(resp);
                    ...
                    $('.delete-row').click(function(e) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                console.log(id)
                                const url = `<?php echo site_url(); ?>matriculas/matriculas/delete/${id}`;
                                fetch(url)
                                    .then(res=>res.json())
                                    .then(res => {
                                        console.log(res)
    ...
    const newRecord = () => {
        window.location.href = "<?php echo site_url(); ?>matriculas/matriculas/add";
    }
</script>
