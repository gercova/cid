            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif;?>
                        <form action="<?php echo base_url();?>matriculas/Certificados/update" method="POST" >
                            ...
                            <div class="form-group">
                                <div class="col-md-2 <?php echo form_error('fecha_ini') == true ? 'has-error':''?>">
                                    ...
                                    <input type="date" name="fecha_ini" class="form-control" id="fecha_ini" value="<?php echo form_error("fecha_ini") !=false ? set_value("fecha_ini") : $certificado->fecha_ini;?>">
                                ...
                                <div class="col-md-2 <?php echo form_error('fecha_fin') == true ? 'has-error':''?>">
                                    ...
                                    <input type="date" name="fecha_fin" class="form-control" id="fecha_fin" value="<?php echo form_error("fecha_fin") !=false ? set_value("fecha_fin") : $certificado->fecha_fin;?>">
                            ...
                            <div class="form-group">
                                <div class="col-md-2 <?php echo form_error('folio') == true ? 'has-error':''?>">
                                    ...
                                    <input type="text" name="folio" class="form-control" id="folio" value="<?php echo form_error("folio") !=false ? set_value("folio") : $certificado->folio;?>" >
                                ...
                                <div class="col-md-2 <?php echo form_error('descuento') == true ? 'has-error':''?>">
                                    ...
                                    <input type="text" name="correlativo" class="form-control" id="correlativo" value="<?php echo form_error("correlativo") !=false ? set_value("correlativo") : $certificado->correlativo;?>">
                                ...
                                <div class="col-md-2 <?php echo form_error('fecha') == true ? 'has-error':''?>">
                                    ...
                                    <input type="date" name="fecha" class="form-control" id="fecha" value="<?php echo form_error("fecha") !=false ? set_value("fecha") : $certificado->fecha;?>">
                                ...
                                <div class="col-md-2 <?php echo form_error('modalidad') == true ? 'has-error':''?>">
                                    <label for="">TIPO DE PARTICIPANTE :</label>
                                    <input type="text" name="modalidad" class="form-control" id="modalidad" value="<?php echo form_error("modalidad") !=false ? set_value("modalidad") : $certificado->modalidad;?>">
